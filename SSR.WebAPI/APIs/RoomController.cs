...
namespace SSR.WebAPI.APIs
{
    ...
    public class RoomController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] Room model)
        {
            try
            {
                var response = await _roomService.Create(model);
                return Ok(
        ...
        public async Task<IActionResult> Update([FromBody] Room model)
        {
            try
            {
                var response = await _roomService.Update(model);
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                var response = await _roomService.Get();
        ...
        public async Task<IActionResult> GetPagingParam([FromBody] PagingParam param)
        {
            try
            {
                var response = await _roomService.GetPaging(param);
