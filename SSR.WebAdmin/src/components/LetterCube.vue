  ...
  <div v-bind:style="styles" class="spinner spinner--socker">
    <div v-bind:style="innerStyles" class="spinner-inner">
      <div class="cube panelLoad">
        <div v-for="{side, letter} of faces" :key="side" :class="`cube-face cube-face-${side}`">
          <div v-if="letter == 'Image'" style="display: flex; justify-content: center; align-items: center; height: 100%; width: 100%">
            <img src="~@/assets/logo.jpeg" height="50" width="50" />
          </div>
