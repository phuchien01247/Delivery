<script>
import ObjectImage from "@/components/pdfEdtitorLocal/objects/ObjectImage";
import TextEditor from "@/components/pdfEdtitorLocal/Text"
...
<!--         v-if="type== 'text'"-->
<!--         @click="$emit('editText')"-->
<!--         class="tw-left-0 tw-top-0 tw-right-0 tw-w-6 tw-h-6 tw-m-auto tw-rounded-full tw-bg-red-100 tw-cursor-pointer tw-transform tw&#45;&#45;translate-y-1/2 md:tw-scale-25 tw-text-center tw-border tw-border-black"-->
<!--     >-->
