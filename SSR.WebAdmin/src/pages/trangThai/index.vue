...
export default {
  ...
  methods: {
        ...
        if (
          ...
          await this.$store.dispatch("trangThaiStore/create", this.model).then((res) => {
            if (res.resultCode === 'SUCCESS') {
              this.fnGetList();
              this.showModal = false;
              this.model = trangThaiModel.baseJson();
            }
            this.$store.dispatch("snackBarStore/addNotify", notifyModel.addMessage(res))
          });
        }
    ...
    async getAllTrangThai() {
      await this.$store.dispatch("trangThaiStore/getTrangThai").then((res) => {
        if (res.resultCode === 'SUCCESS') {
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4 col-12 d-flex align-items-center">
                <h4 class="font-size-18 fw-bold cs-title-page">Trạng thái</h4>
              </div>
                  ...
                  >
                    <form @submit.prevent="handleSubmit"
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-3">
                            <label class="text-left">Mã trạng thái</label>
                            ...
                            >
                              Mã trạng thái không được để trống.
                            </div>
                          </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                          <div class="mb-3">
                            ...
                            <multiselect v-model="model.nextTrangThai"
