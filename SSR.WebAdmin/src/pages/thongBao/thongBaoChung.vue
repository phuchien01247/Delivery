              ...
              <div class="col-lg-10 col-md-6 col-12">
                <div class="row ">
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <input size="sm" type="text" name="untyped-input" class="form-control" v-model="itemFilter.title"
                           placeholder="Tiêu đề/Nội dung/Tên người tạo..."/>
                  </div>
                  <div class="col-lg-4 col-md-6 col-12">
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <date-picker v-model="itemFilter.ngayTao"
                                 format="DD/MM/YYYY"
                                 value-type="format"
                    >
                      <div slot="input">
                        <input v-model="itemFilter.ngayTao"
              ...
              <div class="col-lg-2" style="display: flex; justify-content: center; align-items: center">
                <div class="row">
                  <div class="col-12 text-center">
                    <b-button @click="handleSearch" variant="light" class="btn w-10 btn-red me-2 mb-1" size="md">
                    ...
                    >
                      ...
                      <template v-slot:cell(title)="data">
                        <div @click="handleDetail(data.item.id), handleChangeStatus(data.item.id)"
                          ...
                          <div v-html="data.item.title" v-else> </div>
                        </div>
