...
export default {
  page: {
    title: "Danh sách lỗi trong ngày",
  ...
  methods: {
    ...
    myProvider(ctx) {
      ...
      this.loading = true
      try {
        let promise = this.$store.dispatch("yeucauloiStore/getPagingParamsLoiNgay", params)
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4 col-12 d-flex align-items-center">
                <h4 class="font-size-18 fw-bold cs-title-page">Danh sách lỗi trong ngày</h4>
              </div>
