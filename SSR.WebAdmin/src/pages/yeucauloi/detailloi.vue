...
<template>
  <Layout>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4 col-12 d-flex align-items-center">
                ...
                <h4 v-if="isActive == true" class="font-size-18 fw-bold cs-title-page" style="padding-left: 20px;"><span
                    class="badge rounded-pill bg-success"><i class="mdi mdi-circle-double"></i> Open</span></h4>
                <h4 v-if="isActive == false" class="font-size-18 fw-bold cs-title-page" style="padding-left: 20px;"><span
                    class="badge rounded-pill bg-primary"><i class="mdi mdi-circle-double"></i> Closed</span></h4>
              ...
              <div class="col-md-8 col-12 text-end">
                ...
                <b-button v-if="isActive == true" type="button" variant="danger" class="btn w-md btn-danger" size="sm"
                  @click="Close()" style="height: 30px;">
                  Đóng yêu cầu
                </b-button>
                <button v-if="isActive == false" type="button" class="btn" size="sm"
              ...
              <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                      <div class="mb-2">
                        ...
                        <label class="form-label cs-title-form" for="validationCustom01">
                          <p ref="myText" v-html="model.description"></p>
                          <p>{{ plainText }}</p>
                        </label>
                      </div>
                    </div>
                ...
                <div class="col-md-5 verticalLine">
                  <div class="row">
                      ...
                      <div class="mb-2">
                        ...
                        <label class="form-label cs-title-form" for="validationCustom01">
                          <i v-for="(value, index) in model.label" :key="index">&nbsp;
                            <span style="font-size: 15px;" class="badge rounded-pill"
                    ...
                    <div class="col-md-12">
                      <div class="mb-2">
                        <i class="mdi mdi-calendar"></i>Ngày đáo hạn:<br>
                        <label class="form-label cs-title-form" for="validationCustom01">
                    ...
                    <div class="col-md-12 col-12 text-end">
                      <b-button variant="primary" type="button" class="btn w-md btn-primary" size="sm"
                        @click="handleUpdate(model.id)">
                        <i class="mdi mdi-keyboard-backspace me-1"> Chỉnh sửa</i>
                      </b-button>
                    </div>
                  </div>
                </div>
                          ...
                          <div v-for="act in acti" :key="act.id">
                            <li>
                              ...
                              <div class="content">
                                ...
                                <p ref="myText" v-html="act.content"></p>
                              </div>
                              <i v-for="(value, index) in act.label" :key="index">&nbsp;
                                <div style="font-size: 15px;" class="badge rounded-pill labelstyle"
                                  v-bind:style="{ background: value.color }">{{ value.name }}</div>
                              </i>
                            </li>
                          </div>
                        </ul>
                                ...
                                <div v-for="comment in comments" :key="comment.id">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                      <h5 class="font-size-14 mb-1">{{ comment.createdBy }}<small
                                          class="text-muted float-end">{{ converttime(comment.createdAt) }}</small>
                                      </h5>
                                      <p ref="myText" v-html="comment.content" class="text-muted"></p>
                                      <!-- <div>
    ...
    <!-- <div class="row">
                <div class="col-md-12">
                  <div class="mb-2">
                    <label class="form-label cs-title-form" for="validationCustom01"> Viết bình luận</label>
                    <ckeditor-nuxt class="ckeditor" v-model="modelcomment.content" :config="editorConfig" />
                  </div>
                </div>
                <div class="col-md-12 col-12 text-end">
